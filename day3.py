a = """..............423....688..934............970................................95.728..........896...113..................153..972.............
...122..................*.....*..........................919..509*..........&...@.........../...........................+.......*...........
...
for i in b:
    arr.append(list(i))
sum = 0
def findSchematic(beg, end, y):
    if y != 0:
        isFirst = 0
        isLast = 1
        if beg != 0: isFirst = 1
        if end == len(arr[y-1]): isLast = 0 
        for i in range(beg-isFirst, end+isLast):
            char = arr[y-1][i]            
            if char in symbols:
                return True
    if y != len(arr)-1:
        ...
        for i in range(beg-isFirst, end+isLast):
            ...
            if char in symbols:
                return True
    if beg != 0 and arr[y][beg-1] in symbols: return True
    if end != len(arr[y]) and arr[y][end] in symbols: return True
    ...
    while j < len(arr[i]):
        if arr[i][j].isnumeric():
            ...
            while j < len(arr[i]) and arr[i][j].isnumeric():
                ...
                number += int(arr[i][j])
                j += 1
            isGood = findSchematic(indexBeg, j, i)
            if isGood: sum+=number
        else:
            j += 1
